...
//, animal_safe_distance(mConfig["simulation"]["animal"]["random walk low energy"].toDouble())
    ...
    , animal_tired_threshold(mConfig["simulation"]["animal"]["tired threshold"].toDouble())
// gerbil
    , gerbil_max_speed(mConfig["simulation"]["animal"]["gerbil"]["max speed"].toDouble())
    , gerbil_tired_max_speed(mConfig["simulation"]["animal"]["gerbil"]["tired max speed"].toDouble())
    , gerbil_feeding_break(sf::seconds(mConfig["simulation"]["animal"]["gerbil"]["feeding"]["break time"].toDouble()))
    , gerbil_feeding_efficiency(mConfig["simulation"]["animal"]["gerbil"]["feeding"]["efficiency"].toDouble())
    ...
    , gerbil_giving_birth_break(sf::seconds(mConfig["simulation"]["animal"]["gerbil"]["reproduction"]["giving birth time"].toDouble()))
...
// scorpion
    ...
    , scorpion_tired_max_speed(mConfig["simulation"]["animal"]["scorpion"]["tired max speed"].toDouble())
    , scorpion_feeding_break(sf::seconds(mConfig["simulation"]["animal"]["scorpion"]["feeding"]["break time"].toDouble()))
    , scorpion_feeding_efficiency(mConfig["simulation"]["animal"]["scorpion"]["feeding"]["efficiency"].toDouble())
    ...
    , scorpion_giving_birth_break(sf::seconds(mConfig["simulation"]["animal"]["scorpion"]["reproduction"]["giving birth time"].toDouble()))
